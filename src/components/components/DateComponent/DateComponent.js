  ...
  render() {
    ...
    return (
      <div style={{ position: "relative" }}>
        <label {...styleNameFactory("label")}>День:</label>
        ...
        <div style={{ position: "absolute" }} {...styleNameFactory("link")}>
          <select onChange={this.setActiveComponent}>
            <option value={DayOfWeek.className}>день недели</option>
            <option value={DayOfMonth.className}>месяц</option>
            <option value={Month.className}>год</option>
          </select>
        </div>
      </div>
    );
